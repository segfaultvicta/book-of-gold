...
namespace Book_of_Gold.Pages.Settings
{
        ...
        : NotifyPropertyChanged
    {
        ...
        private bool _colourLoadedYet = false;
        ...
        private void SyncThemeAndColor()
        {
            ...
            if(this._colourLoadedYet)
            {
                ProgramSettings.Default.SelectedThemeDisplayName = this.SelectedTheme.DisplayName;
                ProgramSettings.Default.SelectedThemeSource = this.SelectedTheme.Source;
                ProgramSettings.Default.SelectedAccentColor = this.SelectedAccentColor;
                ProgramSettings.Default.SelectedFontSize = this.SelectedFontSize;
